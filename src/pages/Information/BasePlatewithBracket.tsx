...
const BasePlatewithBracket2 = require("@assets/Infomation/BasePlatewithBracket/BasePlatewithBracket2.png");
...
const BracketorMountingArm = () => {
  return (
    <View style={[globalStyles.container, styles.container]}>
      ...
      >
        <CardTitle title="Information" model={BasePlatewithBracket} modelTitle="Base Plate with Bracket."/>
        <View style={styles.detailContainer}>
          <DetailText text={infoDetail[0]} type="title" />
          <DetailText text={infoDetail[1]} type="paragraph" />
          <DetailImage image={BasePlatewithBracket2} />
